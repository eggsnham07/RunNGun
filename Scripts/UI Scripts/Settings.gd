...
func _ready():
	if Global.fileDoesExist("user://framerate.cfg"): get_node("Framerate/FramerateInput").text = String(Global.loadFromFile("user://framerate.cfg"))
...
func _on_VSync_toggled(button_pressed):
	Global.writeToFile("user://vsync.cfg", String(button_pressed))
...
func _on_FullScreen_toggled(button_pressed):
	Global.writeToFile("user://fullscreen.cfg", String(button_pressed))
	if Global.debug_mode:
...
func _on_Update_pressed():
	Global.writeToFile("user://framerate.cfg", get_node("Framerate/FramerateInput").text)
	if Global.debug_mode:
